...
export declare const userRoleEnum: import("drizzle-orm/pg-core").PgEnum<["spectator", "team_manager", "admin", "super_admin", "producer"]>;
...
export declare const matchEventTypeEnum: import("drizzle-orm/pg-core").PgEnum<["goal", "score_correction", "chukker_start", "chukker_end", "match_start", "match_end", "clock_start", "clock_pause", "penalty", "horse_change", "safety", "injury_timeout", "bowl_in", "knock_in", "foul", "penalty_goal", "shot_on_goal"]>;
